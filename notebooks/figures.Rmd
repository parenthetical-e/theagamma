...
p1 + p2 + plot_layout(widths = c(0.2, 0.8)) +
  plot_annotation(tag_levels = 'a', tag_suffix = ".")
ggsave("figures/overall1.pdf", dpi=300, width = 8, height = 3)
ggsave("figures/overall1.png", dpi=300, width = 8, height = 3)
```
...
ggsave(
  "figures/overall2.pdf",
  dpi = 300,
  width = 9,
  height = 8
)
ggsave(
  "figures/overall2.png",
  dpi = 300,
  width = 9,
  height = 8
)
...
p1 + p2 + p5 + p3 + p4 + 
  ...
  plot_layout(design = layout)
ggsave("figures/overall3.pdf", dpi=300, width = 9, height = 8)
ggsave("figures/overall3.png", dpi=300, width = 9, height = 8)
```
