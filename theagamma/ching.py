...
def ching_coupling(num_pop=25000,
    ...
    ratemonEch = PopulationRateMonitor(neuronsEch)
    ...
    d_rates["Ech"] = (np.asarray(ratemonEch.t), np.asarray(ratemonEch.rate))
